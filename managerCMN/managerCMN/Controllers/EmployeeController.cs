...
public class EmployeeController : Controller
{
    ...
    public EmployeeController(IEmployeeService employeeService, IDepartmentService departmentService, ILeaveService leaveService, ApplicationDbContext db)
    {
    ...
    public async Task<IActionResult> ImportExcel(IFormFile file)
    {
        ...
        for (int row = 2; row <= lastRow; row++)
        {
            ...
            var emp = new Employee
            {
                ...
                AttendanceCode     = Trim(ws.Cell(row, 10).GetString()),
